...
{
    public partial class Line9 : Form
    {
        public Line9()
        {
            InitializeComponent();
        ...
        List<clsLine9> clsLine7 = new List<clsLine9>();
        List<clsLine9StatTotals> clsLine7StatTotals = new List<clsLine9StatTotals>();
                ...
                if (fileExt.CompareTo(".xls") == 0 || fileExt.CompareTo(".xlsx") == 0)
                {
                    try
                    {
                        ...
                        if (dtExcel.Rows.Count > 0)
                        {
                            ...
                            clsLine7 = new List<clsLine9>();
                            for (int i = 0; i < dtExcel.Rows.Count; i++)
                            {
                                clsLine9 line7 = new clsLine9();                                
                                ...
                                if (i <= objGlobalData.importcount)
                                {
                                    ...
                                    if (line7.EventStatus == "Line 1 fails" || line7.EventStatus == "Line 2 fails" || line7.EventStatus == "Line 3 fails" || line7.EventStatus == "Line 4 fails" || line7.EventStatus == "Line 5 fails" || line7.EventStatus == "Line 6 fails" || line7.EventStatus == "Line 7 fails" || line7.EventStatus == "Line 8 fails" || line7.EventStatus == "Line 9 fails" 
                                    || line7.EventStatus == "Line 1 repd." || line7.EventStatus == "Line 2 repd." || line7.EventStatus == "Line 3 repd." || line7.EventStatus == "Line 4 repd." || line7.EventStatus == "Line 5 repd." || line7.EventStatus == "Line 6 repd." || line7.EventStatus == "Line 7 repd." || line7.EventStatus == "Line 8 repd." || line7.EventStatus == "Line 9 repd." || line7.EventStatus == "" || line7.EventStatus == "None")
                                    {
                                    ...
                                    else
                                    {
                                        if (cmbAuto.SelectedIndex == 0)
                                        {
                                            ...
                                            FrmDisplay frmd = new FrmDisplay(line7.EventStatus, 9);
                                            dr = frmd.ShowDialog();
                                            if (dr == DialogResult.OK)
                                            {
                                                ...
                                                if (frmd.EventStatus == "")
                                                {
                                                    ...
                                                    FrmDisplay frmd1 = new FrmDisplay(line7.EventStatus, 9);
        ...
        List<clsLine9Statistics> clsLine7Stats = new List<Maintainance_GeneralLines.clsLine9Statistics>();
        clsLine9StatTotals clsLine7StatTotal = new clsLine9StatTotals();

        // To caluculate totals for the given lines
        private void btnWaittime_Click(object sender, EventArgs e)
        {
            clsLine7StatTotal = new clsLine9StatTotals();
            clsLine7Stats = new List<Maintainance_GeneralLines.clsLine9Statistics>();
            ...
            {
                int i = 1;
                foreach (clsLine9 line7 in clsLine7)
                {
                    clsLine9Statistics clsLine7Statistics = new Maintainance_GeneralLines.clsLine9Statistics();
                ...
                clsLine9Statistics clsLine7StatisticsTot = new clsLine9Statistics();
        ...
        List<clsLine9MonthTotal> clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine9MonthTotal>();
        private void btnTotals_Click(object sender, EventArgs e)
        {
            clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine9MonthTotal>();
            for (int i = 1; i <= 9; i++)
            {
                clsLine9MonthTotal clsLine7MonthTot = new Maintainance_GeneralLines.clsLine9MonthTotal();
