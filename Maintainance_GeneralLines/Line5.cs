...
{
    public partial class Line5 : Form
    {
        public Line5()
        {
            InitializeComponent();
        ...
        List<clsLine5> clsLine7 = new List<clsLine5>();
        List<clsLine5StatTotals> clsLine7StatTotals = new List<clsLine5StatTotals>();
                ...
                if (fileExt.CompareTo(".xls") == 0 || fileExt.CompareTo(".xlsx") == 0)
                {
                    try
                    {
                        ...
                        if (dtExcel.Rows.Count > 0)
                        {
                            ...
                            clsLine7 = new List<clsLine5>();
                            for (int i = 0; i < dtExcel.Rows.Count; i++)
                            {
                                clsLine5 line7 = new clsLine5();
                                ...
                                if (i <= objGlobalData.importcount)
                                {
                                    ...
                                    if (line7.EventStatus == "Line 1 fails" || line7.EventStatus == "Line 2 fails" || line7.EventStatus == "Line 3 fails" || line7.EventStatus == "Line 4 fails" || line7.EventStatus == "Line 5 fails"
                                                 || line7.EventStatus == "Line 1 repd." || line7.EventStatus == "Line 2 repd." || line7.EventStatus == "Line 3 repd." || line7.EventStatus == "Line 4 repd." || line7.EventStatus == "Line 5 repd." || line7.EventStatus == "" || line7.EventStatus == "None")
                                    {
                                    ...
                                    else
                                    {
                                        if (cmbAuto.SelectedIndex == 0)
                                        {
                                            ...
                                            FrmDisplay frmd = new FrmDisplay(line7.EventStatus, 5);
                                            dr = frmd.ShowDialog();
                                            if (dr == DialogResult.OK)
                                            {
                                                ...
                                                if (frmd.EventStatus == "")
                                                {
                                                    ...
                                                    FrmDisplay frmd1 = new FrmDisplay(line7.EventStatus, 5);
        ...
        List<clsLine5Statistics> clsLine7Stats = new List<Maintainance_GeneralLines.clsLine5Statistics>();
        clsLine5StatTotals clsLine7StatTotal = new clsLine5StatTotals();

        // To caluculate totals for the given lines
        private void btnWaittime_Click(object sender, EventArgs e)
        {
            clsLine7StatTotal = new clsLine5StatTotals();
            clsLine7Stats = new List<Maintainance_GeneralLines.clsLine5Statistics>();
            ...
            {
                int i = 1;
                foreach (clsLine5 line7 in clsLine7)
                {
                    clsLine5Statistics clsLine7Statistics = new Maintainance_GeneralLines.clsLine5Statistics();
                ...
                clsLine5Statistics clsLine7StatisticsTot = new clsLine5Statistics();
        ...
        List<clsLine5MonthTotal> clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine5MonthTotal>();
        private void btnTotals_Click(object sender, EventArgs e)
        {
            clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine5MonthTotal>();
            for (int i = 1; i <= 7; i++)
            {
                clsLine5MonthTotal clsLine7MonthTot = new Maintainance_GeneralLines.clsLine5MonthTotal();
