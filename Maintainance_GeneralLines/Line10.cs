...
{
    public partial class Line10 : Form
    {
        public Line10()
        {
            InitializeComponent();
        ...
        List<clsLine10L> clsLine7 = new List<clsLine10L>();
        List<clsLine10StatTotals> clsLine7StatTotals = new List<clsLine10StatTotals>();
                ...
                if (fileExt.CompareTo(".xls") == 0 || fileExt.CompareTo(".xlsx") == 0)
                {
                    try
                    {
                        ...
                        if (dtExcel.Rows.Count > 0)
                        {
                            ...
                            clsLine7 = new List<clsLine10L>();
                            for (int i = 0; i < dtExcel.Rows.Count; i++)
                            {
                                clsLine10L line7 = new clsLine10L();
                                ...
                                if (i >= 1)
                                {
                                    ...
                                    line7.Line8 = dtExcel.Rows[i][9].ToString();
                                    line7.Line9 = dtExcel.Rows[i][10].ToString();
                                    line7.Line10 = dtExcel.Rows[i][11].ToString();
                                ...
                                if (i <= objGlobalData.importcount)
                                {
                                    ...
                                    if (line7.EventStatus == "Line 1 fails" || line7.EventStatus == "Line 2 fails" || line7.EventStatus == "Line 3 fails" || line7.EventStatus == "Line 4 fails" || line7.EventStatus == "Line 5 fails" || line7.EventStatus == "Line 6 fails" || line7.EventStatus == "Line 7 fails" || line7.EventStatus == "Line 8 fails" || line7.EventStatus == "Line 9 fails" || line7.EventStatus == "Line 10 fails"
                                    || line7.EventStatus == "Line 1 repd." || line7.EventStatus == "Line 2 repd." || line7.EventStatus == "Line 3 repd." || line7.EventStatus == "Line 4 repd." || line7.EventStatus == "Line 5 repd." || line7.EventStatus == "Line 6 repd." || line7.EventStatus == "Line 7 repd." || line7.EventStatus == "Line 8 repd." || line7.EventStatus == "Line 9 repd." || line7.EventStatus == "Line 10 repd." || line7.EventStatus == "" || line7.EventStatus == "None")
                                    {
                                    ...
                                    else
                                    {
                                        if (cmbAuto.SelectedIndex == 0)
                                        {
                                            ...
                                            FrmDisplay frmd = new FrmDisplay(line7.EventStatus,10);
                                            dr = frmd.ShowDialog();
                                            if (dr == DialogResult.OK)
                                            {
                                                ...
                                                if (frmd.EventStatus == "")
                                                {
                                                    ...
                                                    FrmDisplay frmd1 = new FrmDisplay(line7.EventStatus,10);
        ...
        List<clsLine10Statistics> clsLine7Stats = new List<Maintainance_GeneralLines.clsLine10Statistics>();
        clsLine10StatTotals clsLine7StatTotal = new clsLine10StatTotals();

        // To caluculate totals for the given lines
        private void btnWaittime_Click(object sender, EventArgs e)
        {
            clsLine7StatTotal = new clsLine10StatTotals();
            clsLine7Stats = new List<Maintainance_GeneralLines.clsLine10Statistics>();
            ...
            // Line8 Totals
            clsLine7StatTotal.Line8DownTotal = RemainingTime;
            clsLine7StatTotal.Line8UpTotal = RemainingTime;
            clsLine7StatTotal.Line8DownKTotal = kremaining;
            clsLine7StatTotal.Line8UpKTotal = kremaining;
            clsLine7StatTotal.Line8WaitingTotal = RemainingTime;
            clsLine7StatTotal.Line8Down = TsZero;
            clsLine7StatTotal.Line8Up = TsZero;
            clsLine7StatTotal.Line8Wait = TsZero;

            // Line9 Totals
            clsLine7StatTotal.Line9DownTotal = RemainingTime;
            clsLine7StatTotal.Line9UpTotal = RemainingTime;
            clsLine7StatTotal.Line9DownKTotal = kremaining;
            clsLine7StatTotal.Line9UpKTotal = kremaining;
            clsLine7StatTotal.Line9WaitingTotal = RemainingTime;
            clsLine7StatTotal.Line9Down = TsZero;
            clsLine7StatTotal.Line9Up = TsZero;
            clsLine7StatTotal.Line9Wait = TsZero;

            // Line10 Totals
            clsLine7StatTotal.Line10DownTotal = RemainingTime;
            clsLine7StatTotal.Line10UpTotal = RemainingTime;
            clsLine7StatTotal.Line10DownKTotal = kremaining;
            clsLine7StatTotal.Line10UpKTotal = kremaining;
            clsLine7StatTotal.Line10WaitingTotal = RemainingTime;
            clsLine7StatTotal.Line10Down = TsZero;
            clsLine7StatTotal.Line10Up = TsZero;
            clsLine7StatTotal.Line10Wait = TsZero;

            if (clsLine7.Count > 0)
            {
                int i = 1;
                foreach (clsLine10L line7 in clsLine7)
                {
                    clsLine10Statistics clsLine7Statistics = new Maintainance_GeneralLines.clsLine10Statistics();
                    if (!string.IsNullOrEmpty(line7.Time))
                    {
                        ...
                        // Line 8 Statistics
                        if (line7.EventStatus == "Line 8 fails")
                        {
                            clsLine7Statistics.Line8Down = line7.Time;
                            clsLine7Statistics.Line8DownK = k;
                            clsLine7Statistics.Line8Up = RemainingTime;
                            clsLine7Statistics.Line8UpK = kremaining;


                            clsLine7StatTotal.Line8Down = clsLine7StatTotal.Line8Down + TsTime;
                            clsLine7StatTotal.Line8DownKTotal = clsLine7StatTotal.Line8DownKTotal + k;

                        }
                        else
                        {
                            clsLine7Statistics.Line8Down = RemainingTime;
                            clsLine7Statistics.Line8DownK = kremaining;
                            clsLine7Statistics.Line8Up = RemainingTime;
                            clsLine7Statistics.Line8UpK = kremaining;
                        }
                        if (line7.EventStatus == "Line 8 repd.")
                        {
                            clsLine7Statistics.Line8Down = RemainingTime;
                            clsLine7Statistics.Line8DownK = kremaining;
                            clsLine7Statistics.Line8Up = line7.Time;
                            clsLine7Statistics.Line8UpK = k;

                            clsLine7StatTotal.Line8Up = clsLine7StatTotal.Line8Up + TsTime;
                            clsLine7StatTotal.Line8UpKTotal = clsLine7StatTotal.Line8UpKTotal + k;

                        }
                        if (line7.Line8 == "Dn(waiting)")
                        {
                            clsLine7Statistics.Line8Waiting = line7.Wait;

                            clsLine7StatTotal.Line8Wait = clsLine7StatTotal.Line8Wait + TsWait;

                        }
                        else
                            clsLine7Statistics.Line8Waiting = RemainingTime;

                        // Line 9 Statistics
                        if (line7.EventStatus == "Line 9 fails")
                        {
                            clsLine7Statistics.Line9Down = line7.Time;
                            clsLine7Statistics.Line9DownK = k;
                            clsLine7Statistics.Line9Up = RemainingTime;
                            clsLine7Statistics.Line9UpK = kremaining;


                            clsLine7StatTotal.Line9Down = clsLine7StatTotal.Line9Down + TsTime;
                            clsLine7StatTotal.Line9DownKTotal = clsLine7StatTotal.Line9DownKTotal + k;

                        }
                        else
                        {
                            clsLine7Statistics.Line9Down = RemainingTime;
                            clsLine7Statistics.Line9DownK = kremaining;
                            clsLine7Statistics.Line9Up = RemainingTime;
                            clsLine7Statistics.Line9UpK = kremaining;
                        }
                        if (line7.EventStatus == "Line 9 repd.")
                        {
                            clsLine7Statistics.Line9Down = RemainingTime;
                            clsLine7Statistics.Line9DownK = kremaining;
                            clsLine7Statistics.Line9Up = line7.Time;
                            clsLine7Statistics.Line9UpK = k;

                            clsLine7StatTotal.Line9Up = clsLine7StatTotal.Line9Up + TsTime;
                            clsLine7StatTotal.Line9UpKTotal = clsLine7StatTotal.Line9UpKTotal + k;

                        }
                        if (line7.Line9 == "Dn(waiting)")
                        {
                            clsLine7Statistics.Line9Waiting = line7.Wait;

                            clsLine7StatTotal.Line9Wait = clsLine7StatTotal.Line9Wait + TsWait;

                        }
                        else
                            clsLine7Statistics.Line9Waiting = RemainingTime;

                        // Line 10 Statistics
                        if (line7.EventStatus == "Line 10 fails")
                        {
                            clsLine7Statistics.Line10Down = line7.Time;
                            clsLine7Statistics.Line10DownK = k;
                            clsLine7Statistics.Line10Up = RemainingTime;
                            clsLine7Statistics.Line10UpK = kremaining;


                            clsLine7StatTotal.Line10Down = clsLine7StatTotal.Line10Down + TsTime;
                            clsLine7StatTotal.Line10DownKTotal = clsLine7StatTotal.Line10DownKTotal + k;

                        }
                        else
                        {
                            clsLine7Statistics.Line10Down = RemainingTime;
                            clsLine7Statistics.Line10DownK = kremaining;
                            clsLine7Statistics.Line10Up = RemainingTime;
                            clsLine7Statistics.Line10UpK = kremaining;
                        }
                        if (line7.EventStatus == "Line 10 repd.")
                        {
                            clsLine7Statistics.Line10Down = RemainingTime;
                            clsLine7Statistics.Line10DownK = kremaining;
                            clsLine7Statistics.Line10Up = line7.Time;
                            clsLine7Statistics.Line10UpK = k;

                            clsLine7StatTotal.Line10Up = clsLine7StatTotal.Line10Up + TsTime;
                            clsLine7StatTotal.Line10UpKTotal = clsLine7StatTotal.Line10UpKTotal + k;

                        }
                        if (line7.Line10 == "Dn(waiting)")
                        {
                            clsLine7Statistics.Line10Waiting = line7.Wait;

                            clsLine7StatTotal.Line10Wait = clsLine7StatTotal.Line10Wait + TsWait;

                        }
                        else
                            clsLine7Statistics.Line10Waiting = RemainingTime;
                ...
                clsLine10Statistics clsLine7StatisticsTot = new clsLine10Statistics();
                ...
                // Line 8 Stat Totals 
                clsLine7StatisticsTot.Line8Down = Math.Floor(clsLine7StatTotal.Line8Down.TotalHours).ToString() + ":" + clsLine7StatTotal.Line8Down.Minutes.ToString() + ":" + clsLine7StatTotal.Line8Down.Seconds.ToString();
                clsLine7StatisticsTot.Line8DownK = clsLine7StatTotal.Line8DownKTotal;
                clsLine7StatisticsTot.Line8Up = Math.Floor(clsLine7StatTotal.Line8Up.TotalHours).ToString() + ":" + clsLine7StatTotal.Line8Up.Minutes.ToString() + ":" + clsLine7StatTotal.Line8Up.Seconds.ToString();
                clsLine7StatisticsTot.Line8UpK = clsLine7StatTotal.Line8UpKTotal;
                clsLine7StatisticsTot.Line8Waiting = Math.Floor(clsLine7StatTotal.Line8Wait.TotalHours).ToString() + ":" + clsLine7StatTotal.Line8Wait.Minutes.ToString() + ":" + clsLine7StatTotal.Line8Wait.Seconds.ToString();


                // Line 9 Stat Totals 
                clsLine7StatisticsTot.Line9Down = Math.Floor(clsLine7StatTotal.Line9Down.TotalHours).ToString() + ":" + clsLine7StatTotal.Line9Down.Minutes.ToString() + ":" + clsLine7StatTotal.Line9Down.Seconds.ToString();
                clsLine7StatisticsTot.Line9DownK = clsLine7StatTotal.Line9DownKTotal;
                clsLine7StatisticsTot.Line9Up = Math.Floor(clsLine7StatTotal.Line9Up.TotalHours).ToString() + ":" + clsLine7StatTotal.Line9Up.Minutes.ToString() + ":" + clsLine7StatTotal.Line9Up.Seconds.ToString();
                clsLine7StatisticsTot.Line9UpK = clsLine7StatTotal.Line9UpKTotal;
                clsLine7StatisticsTot.Line9Waiting = Math.Floor(clsLine7StatTotal.Line9Wait.TotalHours).ToString() + ":" + clsLine7StatTotal.Line9Wait.Minutes.ToString() + ":" + clsLine7StatTotal.Line9Wait.Seconds.ToString();


                // Line 10 Stat Totals 
                clsLine7StatisticsTot.Line10Down = Math.Floor(clsLine7StatTotal.Line10Down.TotalHours).ToString() + ":" + clsLine7StatTotal.Line10Down.Minutes.ToString() + ":" + clsLine7StatTotal.Line10Down.Seconds.ToString();
                clsLine7StatisticsTot.Line10DownK = clsLine7StatTotal.Line10DownKTotal;
                clsLine7StatisticsTot.Line10Up = Math.Floor(clsLine7StatTotal.Line10Up.TotalHours).ToString() + ":" + clsLine7StatTotal.Line10Up.Minutes.ToString() + ":" + clsLine7StatTotal.Line10Up.Seconds.ToString();
                clsLine7StatisticsTot.Line10UpK = clsLine7StatTotal.Line10UpKTotal;
                clsLine7StatisticsTot.Line10Waiting = Math.Floor(clsLine7StatTotal.Line10Wait.TotalHours).ToString() + ":" + clsLine7StatTotal.Line10Wait.Minutes.ToString() + ":" + clsLine7StatTotal.Line10Wait.Seconds.ToString();
                ...
                // Line 8
                objGlobalData.Line8Down = clsLine7StatTotal.Line8Down;
                objGlobalData.Line8Up = clsLine7StatTotal.Line8Up;
                objGlobalData.Line8Waiting = clsLine7StatTotal.Line8Wait;
                objGlobalData.Line8DownK = clsLine7StatTotal.Line8DownKTotal;
                objGlobalData.Line8UpK = clsLine7StatTotal.Line8UpKTotal;

                // Line 9
                objGlobalData.Line9Down = clsLine7StatTotal.Line9Down;
                objGlobalData.Line9Up = clsLine7StatTotal.Line9Up;
                objGlobalData.Line9Waiting = clsLine7StatTotal.Line9Wait;
                objGlobalData.Line9DownK = clsLine7StatTotal.Line9DownKTotal;
                objGlobalData.Line9UpK = clsLine7StatTotal.Line9UpKTotal;

                // Line 10
                objGlobalData.Line10Down = clsLine7StatTotal.Line10Down;
                objGlobalData.Line10Up = clsLine7StatTotal.Line10Up;
                objGlobalData.Line10Waiting = clsLine7StatTotal.Line10Wait;
                objGlobalData.Line10DownK = clsLine7StatTotal.Line10DownKTotal;
                objGlobalData.Line10UpK = clsLine7StatTotal.Line10UpKTotal;
        ...
        List<clsLine10MonthTotal> clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine10MonthTotal>();
        private void btnTotals_Click(object sender, EventArgs e)
        {
            clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine10MonthTotal>();
            for (int i = 1; i <= 10; i++)
            {
                clsLine10MonthTotal clsLine7MonthTot = new Maintainance_GeneralLines.clsLine10MonthTotal();
                ...
                {
                    clsLine7MonthTot.Line = "Line" + i.ToString();
                    TsDown = objGlobalData.Line8Up - objGlobalData.Line8Down;
                    TsUp = objGlobalData.TotalTime - TsDown;
                    TsWait = objGlobalData.Line8Waiting;


                    double MTTF = getRemaining(TsUp, objGlobalData.Line8DownK);
                    double lambda = Math.Round(1 / MTTF, 5);

                    double MTTR = getRemaining(TsDown, objGlobalData.Line8UpK);
                    double Mu = Math.Round(1 / MTTR, 5);
                ...
                {
                    clsLine7MonthTot.Line = "Line" + i.ToString();
                    TsDown = objGlobalData.Line9Up - objGlobalData.Line9Down;
                    TsUp = objGlobalData.TotalTime - TsDown;
                    TsWait = objGlobalData.Line9Waiting;


                    double MTTF = getRemaining(TsUp, objGlobalData.Line9DownK);
                    double lambda = Math.Round(1 / MTTF, 5);

                    double MTTR = getRemaining(TsDown, objGlobalData.Line9UpK);
                    double Mu = Math.Round(1 / MTTR, 5);
                ...
                {
                    clsLine7MonthTot.Line = "Line" + i.ToString();
                    TsDown = objGlobalData.Line10Up - objGlobalData.Line10Down;
                    TsUp = objGlobalData.TotalTime - TsDown;
                    TsWait = objGlobalData.Line10Waiting;


                    double MTTF = getRemaining(TsUp, objGlobalData.Line10DownK);
                    double lambda = Math.Round(1 / MTTF, 5);

                    double MTTR = getRemaining(TsDown, objGlobalData.Line10UpK);
                    double Mu = Math.Round(1 / MTTR, 5);
