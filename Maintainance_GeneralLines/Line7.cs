...
{
    public partial class Line7 : Form
    {
        public Line7()
        {
            InitializeComponent();
        ...
        List<clsLine7> clsLine7 = new List<clsLine7>();
        List<clsLine7StatTotals> clsLine7StatTotals = new List<clsLine7StatTotals>();
                ...
                if (fileExt.CompareTo(".xls") == 0 || fileExt.CompareTo(".xlsx") == 0)
                {
                    try
                    {
                        ...
                        if (dtExcel.Rows.Count > 0)
                        {
                            ...
                            clsLine7 = new List<clsLine7>();
                            for (int i = 0; i < dtExcel.Rows.Count; i++)
                            {
                                clsLine7 line7 = new clsLine7();                                
                                ...
                                if (i <= objGlobalData.importcount)
                                {
                                    ...
                                    if (line7.EventStatus == "Line 1 fails" || line7.EventStatus == "Line 2 fails" || line7.EventStatus == "Line 3 fails" || line7.EventStatus == "Line 4 fails" || line7.EventStatus == "Line 5 fails" || line7.EventStatus == "Line 6 fails" || line7.EventStatus == "Line 7 fails" 
                                    || line7.EventStatus == "Line 1 repd." || line7.EventStatus == "Line 2 repd." || line7.EventStatus == "Line 3 repd." || line7.EventStatus == "Line 4 repd." || line7.EventStatus == "Line 5 repd." || line7.EventStatus == "Line 6 repd." || line7.EventStatus == "Line 7 repd."  || line7.EventStatus == "" || line7.EventStatus == "None")
                                    {
                                    ...
                                    else
                                    {
                                        if (cmbAuto.SelectedIndex == 0)
                                        {
                                            ...
                                            FrmDisplay frmd = new FrmDisplay(line7.EventStatus, 7);
                                            dr = frmd.ShowDialog();
                                            if (dr == DialogResult.OK)
                                            {
                                                ...
                                                if (frmd.EventStatus == "")
                                                {
                                                    ...
                                                    FrmDisplay frmd1 = new FrmDisplay(line7.EventStatus, 7);
        ...
        List<clsLine7Statistics> clsLine7Stats = new List<Maintainance_GeneralLines.clsLine7Statistics>();
        clsLine7StatTotals clsLine7StatTotal = new clsLine7StatTotals();

        // To caluculate totals for the given lines
        private void btnWaittime_Click(object sender, EventArgs e)
        {
            clsLine7StatTotal = new clsLine7StatTotals();
            clsLine7Stats = new List<Maintainance_GeneralLines.clsLine7Statistics>();
            ...
            {
                int i = 1;
                foreach (clsLine7 line7 in clsLine7)
                {
                    clsLine7Statistics clsLine7Statistics = new Maintainance_GeneralLines.clsLine7Statistics();
                ...
                clsLine7Statistics clsLine7StatisticsTot = new clsLine7Statistics();
        ...
        List<clsLine7MonthTotal> clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine7MonthTotal>();
        private void btnTotals_Click(object sender, EventArgs e)
        {
            clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine7MonthTotal>();
            for (int i = 1; i <= 7; i++)
            {
                clsLine7MonthTotal clsLine7MonthTot = new Maintainance_GeneralLines.clsLine7MonthTotal();
