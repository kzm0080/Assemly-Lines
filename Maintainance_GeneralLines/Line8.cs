...
{
    public partial class Line8 : Form
    {
        public Line8()
        {
            InitializeComponent();
        ...
        List<clsLine8> clsLine7 = new List<clsLine8>();
        List<clsLine8StatTotals> clsLine7StatTotals = new List<clsLine8StatTotals>();
                ...
                if (fileExt.CompareTo(".xls") == 0 || fileExt.CompareTo(".xlsx") == 0)
                {
                    try
                    {
                        ...
                        if (dtExcel.Rows.Count > 0)
                        {
                            ...
                            clsLine7 = new List<clsLine8>();
                            for (int i = 0; i < dtExcel.Rows.Count; i++)
                            {
                                clsLine8 line7 = new clsLine8();                                
                                ...
                                if (i <= objGlobalData.importcount)
                                {
                                    ...
                                    if (line7.EventStatus == "Line 1 fails" || line7.EventStatus == "Line 2 fails" || line7.EventStatus == "Line 3 fails" || line7.EventStatus == "Line 4 fails" || line7.EventStatus == "Line 5 fails" || line7.EventStatus == "Line 6 fails" || line7.EventStatus == "Line 7 fails" || line7.EventStatus == "Line 8 fails" 
                                    || line7.EventStatus == "Line 1 repd." || line7.EventStatus == "Line 2 repd." || line7.EventStatus == "Line 3 repd." || line7.EventStatus == "Line 4 repd." || line7.EventStatus == "Line 5 repd." || line7.EventStatus == "Line 6 repd." || line7.EventStatus == "Line 7 repd." || line7.EventStatus == "Line 8 repd."  || line7.EventStatus == "" || line7.EventStatus == "None")
                                    {
                                    ...
                                    else
                                    {
                                        if (cmbAuto.SelectedIndex == 0)
                                        {
                                            ...
                                            FrmDisplay frmd = new FrmDisplay(line7.EventStatus, 8);
                                            dr = frmd.ShowDialog();
                                            if (dr == DialogResult.OK)
                                            {
                                                ...
                                                if (frmd.EventStatus == "")
                                                {
                                                    ...
                                                    FrmDisplay frmd1 = new FrmDisplay(line7.EventStatus, 8);
        ...
        List<clsLine8Statistics> clsLine7Stats = new List<Maintainance_GeneralLines.clsLine8Statistics>();
        clsLine8StatTotals clsLine7StatTotal = new clsLine8StatTotals();

        // To caluculate totals for the given lines
        private void btnWaittime_Click(object sender, EventArgs e)
        {
            clsLine7StatTotal = new clsLine8StatTotals();
            clsLine7Stats = new List<Maintainance_GeneralLines.clsLine8Statistics>();
            ...
            {
                int i = 1;
                foreach (clsLine8 line7 in clsLine7)
                {
                    clsLine8Statistics clsLine7Statistics = new Maintainance_GeneralLines.clsLine8Statistics();
                ...
                clsLine8Statistics clsLine7StatisticsTot = new clsLine8Statistics();
        ...
        List<clsLine8MonthTotal> clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine8MonthTotal>();
        private void btnTotals_Click(object sender, EventArgs e)
        {
            clsLine7MonthTotal = new List<Maintainance_GeneralLines.clsLine8MonthTotal>();
            for (int i = 1; i <= 10; i++)
            {
                clsLine8MonthTotal clsLine7MonthTot = new Maintainance_GeneralLines.clsLine8MonthTotal();
